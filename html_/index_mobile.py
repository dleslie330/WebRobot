...
<body>
    ...
    <script>
        ...
        document.getElementById("quit").addEventListener("touchstart", function() {
            buttonDown = true;
            buttonID = "quit";
        });
        ...
        document.getElementById("quit").addEventListener("touchend", function() {
            buttonDown = true;
            buttonID = "quit";
        });

        document.getElementById("forward").addEventListener("touchcancel", function() {
            buttonDown = true;
            buttonID = "stop";
        });

        document.getElementById("right").addEventListener("touchcancel", function() {
            buttonDown = true;
            buttonID = "stop";
        });

        document.getElementById("back").addEventListener("touchcancel", function() {
            buttonDown = true;
            buttonID = "stop";
        });

        document.getElementById("left").addEventListener("touchcancel", function() {
            buttonDown = true;
            buttonID = "stop";
        });

        document.getElementById("quit").addEventListener("touchcancel", function() {
            buttonDown = true;
            buttonID = "quit";
        });
